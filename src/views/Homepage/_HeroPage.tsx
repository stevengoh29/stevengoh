    ...
    <div className={`w-full lg:h-screen flex justify-center items-center ${theme == 'light' ? 'bg-main-light' : 'bg-main-dark'}`}>
      <div className="flex flex-col justify-center lg:w-[84rem] h-[28rem] p-5 lg:p-10 lg:gap-3 gap-1">
        ...
        <div className='flex gap-x-5 mt-5'>
          <button className="bg-blue-500 hover:bg-blue-700 active:bg-blue-900 text-white font-bold py-3 px-5 rounded duration-300 uppercase text-xs lg:mt-0 mt-5 lg:w-60 max-w-fit">
            Browse My Projects
          </button>
          <button className="bg-blue-500 hover:bg-blue-700 active:bg-blue-900 text-white font-bold py-3 px-5 rounded duration-300 uppercase text-xs lg:mt-0 mt-5 lg:w-60 max-w-fit">
            About Me
