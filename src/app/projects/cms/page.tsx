  ...
  return (
    <div className="max-w-screen-xl bg-slate-800 m-auto p-10 mb-5">
      ...
      <div className="grid grid-cols-2 gap-10 mt-2">
        <Image
          src={require("../../../assets/projects/screenshot/cinbud/1.png")}
          alt="Login Cinbud"
        />
        <Image
          src={require("../../../assets/projects/screenshot/cinbud/2.png")}
          alt="Home Cinbud"
        />
        <Image
          src={require("../../../assets/projects/screenshot/cinbud/3.png")}
          alt="Home Cinbud"
        />
        <Image
          src={require("../../../assets/projects/screenshot/cinbud/4.png")}
          alt="Home Cinbud"
        />
        <Image
          src={require("../../../assets/projects/screenshot/cinbud/5.png")}
          alt="Home Cinbud"
        />
      </div>
    </div>
