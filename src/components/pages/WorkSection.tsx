...
import SvgWaveBottom from '../svg/svg-wave-bottom'

const PROJECT_CATEGORIES = ['Mobile App', 'Web App / API']
...
export default function WorkSection() {
  ...
  return (
    <React.Fragment>
      <SvgWaveTop />
      <SectionWrapper id='work' className="bg-slate-200 dark:bg-slate-800  w-screen flex-col justify-center items-baseline py-10 gap-10">
